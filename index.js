...
switch (true) {
 case (randomImage === d1 && randomImage1 === d2):
        ...
        document.querySelector(".p2").innerHTML = "<mark>PLAYER 2 Win!</mark>"
        document.querySelector(".p1").innerHTML = "<del>PLAYER 1 Lose!</del>"
        break;
case (randomImage === d1 && randomImage1 === d3):
 ...
 case (randomImage === d2 && randomImage1 === d5):
  ...
  case (randomImage === d3 && randomImage1 === d5):
        document.querySelector("h1").innerHTML = "Dice 5 wins! player 1";
        document.querySelector(".p2").innerHTML = "<mark>PLAYER 2 Win!</mark>"
        document.querySelector(".p1").innerHTML = "<del>PLAYER 1 Lose!</del>"
        break;
 ...
 case (randomImage === d5 && randomImage1 === d6):
   ...
   case (randomImage === d2 && randomImage1 === d1):
        document.querySelector("h1").innerHTML = "Dice 2 wins!";
        document.querySelector(".p2").innerHTML = "<del>PLAYER 2 Lose!</del>"
        document.querySelector(".p1").innerHTML = "<mark>PLAYER 1 Win!</mark>"
...
case (randomImage === d6 && randomImage1 === d4):
 ...
 case (randomImage === d6 && randomImage1 === d5):
        document.querySelector("h1").innerHTML = "Dice 6 ins!";
        document.querySelector(".p2").innerHTML = "<del>PLAYER 2 Lose!</del>"
        document.querySelector(".p1").innerHTML = "<mark>PLAYER 1 Win!</mark>"
        break;
    default:
